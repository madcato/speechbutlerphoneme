...
def ds1_dropout(input_dim=26, fc_size=2048, rnn_size=512, dropout=[0.1, 0.1, 0.1], output_dim=num_classes):
...
def ds1(input_dim=26, fc_size=1024, rnn_size=1024, output_dim=num_classes):
...
def ds2_gru_model(input_dim=161, fc_size=1024, rnn_size=512, output_dim=num_classes, initialization='glorot_uniform',
...
def ownModel(input_dim=26, fc_size=512, rnn_size=512, dropout=[0.1, 0.1, 0.1], output_dim=num_classes):
...
def graves(input_dim=26, rnn_size=512, output_dim=num_classes, std=0.6):
...
def cnn_city(input_dim=161, fc_size=1024, rnn_size=512, output_dim=num_classes, initialization='glorot_uniform',
                  conv_layers=4):
...
def const(input_dim=26, fc_size=1024, rnn_size=1024, output_dim=num_classes):
...
def phonemeModel(input_dim=26, fc_size=512, rnn_size=512, dropout=[0.1, 0.1, 0.1], output_dim=num_classes):
    """ Own model BN+SELU-FC+GRU+BN+DR
...
def build_ds5_no_ctc_and_xfer_weights(loaded_model, input_dim=161, fc_size=1024, rnn_size=512, output_dim=num_classes, initialization='glorot_uniform',
                  conv_layers=4):
    """ Pure CNN implementation"""
